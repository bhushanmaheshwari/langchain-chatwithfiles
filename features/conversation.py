...
def initialize_mongodb():
    if "mongodb_collection" not in st.session_state:
        ...
        st.session_state.mongodb_collection = database[os.environ["MONGODB_COLLECTION"]]
...
def get_conversation_history():
    ...
    records = st.session_state.mongodb_collection.find_one({"session_id" : st.session_state.session_id })
...
def save_chat_history():
    ...
    st.session_state.mongodb_collection.update_one(
